...
// DAY36① 新しい状態を追加（state）にsortOder:"asc "追加
// まず「並び順」も状態にする。
...
function renderList() {
    ...
    //検索で絞る
    let result = state.data.filter(post =>
...
document.getElementById("filterBtn").addEventListener("click",()=>{
    state.searchKeyword = ""; // 例（本当は別stateが理想）
  render();
});
