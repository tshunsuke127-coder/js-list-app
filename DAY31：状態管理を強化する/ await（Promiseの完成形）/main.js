// 🟢 DAY31：状態管理を強化する
// 今日のテーマ
//false状態を表示なしから「データなし」と「データあり」に分ける

// /DAY29 では
// 読み込み中・エラー中は判断できていたが
// それ以外（loading=false, error=null）は
// データがあっても空でも「表示なし」としていた

// DAY31 では
// state.data.length === 0 を追加したことで
// loading=false の中を
// 「データなし」と「データあり」に分けられるようになった
...
//Day31② renderStatus を「状態ベース」に進化させる
// DAY31版 renderStatus
